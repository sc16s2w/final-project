...
void Morpher::on_mousel(int event, int x, int y, int flag, void* param)
{
    ...
    if (counter % 2 == 0 && pm->counter > 0)
    {
        ...
        if (event == EVENT_LBUTTONUP || event == EVENT_RBUTTONUP){
            ...
            line(leftImage, curLinePair.leftLine.P, curLinePair.leftLine.Q, color, thickness, LINE_AA, shift);
...
void Morpher::on_mouser(int event, int x, int y, int flag, void* param)
{
    ...
    if (counter % 2 == 1 && counter > 0)
    {
        ...
        if (event == EVENT_LBUTTONUP || event == EVENT_RBUTTONUP){
            ...
            line(rightImage, curLinePair.rightLine.P, curLinePair.rightLine.Q, color, thickness, LINE_AA, shift);
